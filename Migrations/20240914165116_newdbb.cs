    ...
    public partial class newdbb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Accountantid = table.Column<int>(name: "Accountant_id", type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Accountantname = table.Column<string>(name: "Accountant_name", type: "nvarchar(max)", nullable: false),
                    Accountantemail = table.Column<string>(name: "Accountant_email", type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OnlineApplicationID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StudentName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ApplyingForSTD = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ParentName = table.Column<int>(name: "Parent_Name", type: "int", nullable: false),
                    ParentEmail = table.Column<int>(name: "Parent_Email", type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OnlineApplications", x => x.OnlineApplicationID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeesStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SystemAdminid = table.Column<int>(name: "SystemAdmin_id", type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SystemAdminname = table.Column<string>(name: "SystemAdmin_name", type: "nvarchar(max)", nullable: false),
                    SystemAdminemail = table.Column<string>(name: "SystemAdmin_email", type: "nvarchar(max)", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Password = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    role = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
